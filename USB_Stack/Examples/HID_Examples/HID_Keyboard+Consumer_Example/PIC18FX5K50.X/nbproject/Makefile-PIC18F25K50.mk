...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX5K50.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../../../../USB/usb.c ../../../../USB/usb_hid.c ../Shared_Files/ASCII_2_KEY.c ../Shared_Files/usb_app.c ../Shared_Files/usb_descriptors.c ../Shared_Files/usb_hid_reports.c ../Shared_Files/main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/671494620/usb.p1 ${OBJECTDIR}/_ext/671494620/usb_hid.p1 ${OBJECTDIR}/_ext/1662128652/ASCII_2_KEY.p1 ${OBJECTDIR}/_ext/1662128652/usb_app.p1 ${OBJECTDIR}/_ext/1662128652/usb_descriptors.p1 ${OBJECTDIR}/_ext/1662128652/usb_hid_reports.p1 ${OBJECTDIR}/_ext/1662128652/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/671494620/usb.p1.d ${OBJECTDIR}/_ext/671494620/usb_hid.p1.d ${OBJECTDIR}/_ext/1662128652/ASCII_2_KEY.p1.d ${OBJECTDIR}/_ext/1662128652/usb_app.p1.d ${OBJECTDIR}/_ext/1662128652/usb_descriptors.p1.d ${OBJECTDIR}/_ext/1662128652/usb_hid_reports.p1.d ${OBJECTDIR}/_ext/1662128652/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/671494620/usb.p1 ${OBJECTDIR}/_ext/671494620/usb_hid.p1 ${OBJECTDIR}/_ext/1662128652/ASCII_2_KEY.p1 ${OBJECTDIR}/_ext/1662128652/usb_app.p1 ${OBJECTDIR}/_ext/1662128652/usb_descriptors.p1 ${OBJECTDIR}/_ext/1662128652/usb_hid_reports.p1 ${OBJECTDIR}/_ext/1662128652/main.p1

# Source Files
SOURCEFILES=../../../../USB/usb.c ../../../../USB/usb_hid.c ../Shared_Files/ASCII_2_KEY.c ../Shared_Files/usb_app.c ../Shared_Files/usb_descriptors.c ../Shared_Files/usb_hid_reports.c ../Shared_Files/main.c
...
Device=PIC18F25K50
ProjectDir="C:\Users\John\Desktop\USB-Stack NEW\Examples\HID_Examples\HID_Keyboard+Consumer_Example\PIC18FX5K50.X"
ProjectName=HID_Keyboard_Consumer_Example
ConfName=PIC18F25K50
ImagePath="dist\PIC18F25K50\${IMAGE_TYPE}\PIC18FX5K50.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ImageDir="dist\PIC18F25K50\${IMAGE_TYPE}"
ImageName="PIC18FX5K50.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
IsDebug="true"
else
IsDebug="false"
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-PIC18F25K50.mk dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX5K50.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
	@echo "--------------------------------------"
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX5K50.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX5K50.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_PIC18F25K50=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -Os -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=0x2000  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX5K50.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX5K50.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX5K50.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX5K50.X.${IMAGE_TYPE}.map  -DXPRJ_PIC18F25K50=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -Os -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=0x2000  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX5K50.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
