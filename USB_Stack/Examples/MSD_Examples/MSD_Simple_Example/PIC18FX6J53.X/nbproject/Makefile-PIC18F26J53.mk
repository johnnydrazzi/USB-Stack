...
SOURCEFILES_QUOTED_IF_SPACED=../../../../USB/USB.c ../../../../USB/usb_msd.c ../Shared_Files/usb_app.c ../Shared_Files/usb_descriptors.c ../Shared_Files/usb_scsi_inq.c ../Shared_Files/main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/671494620/USB.p1 ${OBJECTDIR}/_ext/671494620/usb_msd.p1 ${OBJECTDIR}/_ext/1662128652/usb_app.p1 ${OBJECTDIR}/_ext/1662128652/usb_descriptors.p1 ${OBJECTDIR}/_ext/1662128652/usb_scsi_inq.p1 ${OBJECTDIR}/_ext/1662128652/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/671494620/USB.p1.d ${OBJECTDIR}/_ext/671494620/usb_msd.p1.d ${OBJECTDIR}/_ext/1662128652/usb_app.p1.d ${OBJECTDIR}/_ext/1662128652/usb_descriptors.p1.d ${OBJECTDIR}/_ext/1662128652/usb_scsi_inq.p1.d ${OBJECTDIR}/_ext/1662128652/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/671494620/USB.p1 ${OBJECTDIR}/_ext/671494620/usb_msd.p1 ${OBJECTDIR}/_ext/1662128652/usb_app.p1 ${OBJECTDIR}/_ext/1662128652/usb_descriptors.p1 ${OBJECTDIR}/_ext/1662128652/usb_scsi_inq.p1 ${OBJECTDIR}/_ext/1662128652/main.p1

# Source Files
SOURCEFILES=../../../../USB/USB.c ../../../../USB/usb_msd.c ../Shared_Files/usb_app.c ../Shared_Files/usb_descriptors.c ../Shared_Files/usb_scsi_inq.c ../Shared_Files/main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-PIC18F26J53.mk dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX6J53.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX6J53.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX6J53.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_PIC18F26J53=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -mrom=2000-FBFF -Os -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=2000  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX6J53.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX6J53.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX6J53.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX6J53.X.${IMAGE_TYPE}.map  -DXPRJ_PIC18F26J53=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -mrom=2000-FBFF -Os -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=2000  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/PIC18FX6J53.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
